...
local rsa={}
ffi.metatype("struct X509",{__index={verify=function(self,string)
  local pubkey=lib.X509_get_pubkey(self)
  return pubkey:verify(string)
end,digest=function(self,string)
  local pubkey=lib.X509_get_pubkey(self)
  return pubkey:digest(string)
end},__gc=lib.X509_free})
ffi.metatype("struct EVP_PKEY",{__index={verify=function(self,string)
